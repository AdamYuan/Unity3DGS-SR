...
float3 CalcCovariance2D(float3 worldPos, float3 cov3d0, float3 cov3d1, float4x4 matrixV, float4x4 matrixP, float4 screenParams, float lowPassFilterScale = 1.0)
{
    ...
    cov._m00 += 0.3 * lowPassFilterScale * lowPassFilterScale;
    cov._m11 += 0.3 * lowPassFilterScale * lowPassFilterScale;
